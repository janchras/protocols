 ...
 */
public class WG810V2013a extends SerialInterfaceV2013
{
    ...
    public WG810V2013a(String name) throws Exception
    {
        super(name);
        open();
...
//        this.printDebug(paramRead, false);
    ...
    {
        if(par !=  WG810V2013a.MORPHMANUAL && par != WG810V2013a.MORPHEXTERN && par !=WG810V2013a.MORPHTIME)
            throw new Exception("falscher Morphing Parameter!!");
        if(par == WG810V2013a.MORPHEXTERN)
            nr=0;
        paramSend[0] = (byte)'X';
        paramSend[1] = (byte)'[';
        paramSend[2] = (byte)0;
...
//        this.printDebug(paramRead,true);
    ...
    {
        WG810V2013a wg810 = null;
        try
        {
            wg810 = new WG810V2013a("COM3");
...
//            System.out.println("Typ: "+wg810.getTyp());
            ...
            System.out.println("Remote: "+wg810.getRemote());
            Thread.sleep(2000);
            wg810.setKurvenform(WG810V2013a.FORMTRI, 0, true);
            ...
            wg810.setOffsetMode(WG810V2013a.OFFSETSIGPOSNEG, true);
            ...
            wg810.setAusgangsModus(WG810V2013a.OUTPUT0DB, true);
            ...
            wg810.setModulation(WG810V2013a.MODNONE, false);
            System.out.println("Modulation: " + wg810.getModulation());
            
            wg810.setTriggerModus(WG810V2013a.TRIGCONT, false);
            System.out.println("Triggermode: " + wg810.getTriggerModus());

            wg810.setClockSource(WG810V2013a.CLKINTERN,true);
            System.out.println("Taktquelle: " + wg810.getClockSource());
            
            wg810.setMorphingParameter(WG810V2013a.MORPHMANUAL, 3, true);
